...
export default class WWItemSheet extends WWSheetMixin(ItemSheetV2) {
  ...
  async _prepareContext(options = {}) {
    ...
    context.targetingRestrictions = CONFIG.WW.TARGETING_MODES;
      ...
      case 'automation':
        ...
        instEffs.forEach((e,id) => {
          const obj = {...e,
            ...
            targetLoc: CONFIG.WW.TARGETING_MODES[e.target],
        ...
        for (const cat in actEffs) {
          ...
          for (const e in category.effects) {
            ...
            effect.targetLoc = CONFIG.WW.TARGETING_MODES[system.target];
