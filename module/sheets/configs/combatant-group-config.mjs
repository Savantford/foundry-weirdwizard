 ...
 */
export default class WWCombatantGroupConfig extends HandlebarsApplicationMixin(DocumentSheet) {
  /** @inheritdoc */
  static DEFAULT_OPTIONS = {
    classes: ["combatant-group-config", "standard-form"],
    position: { width: 420 },
    form: {
      closeOnSubmit: true,
    },
  ...
  static PARTS = {
    body: {
      template: sysPath("templates/sidebar/combat/combatant-group-config.hbs"),
    },
    footer: {
      template: "templates/generic/form-footer.hbs", // Core template
    },
  };
